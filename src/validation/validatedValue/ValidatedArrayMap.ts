 ...
 */
export type ValidatedArrayMap<T, E> = {
 ...
 */
export const extractArrayChild = <T, E>(
...
export function getExtractArrayChild<T, E>(): ValueExtractor<
  ValidatedValue<T[], E>,
 ...
 */
export const recombineArrayChild = <T, E>(
...
export function getRecombineArrayChild<T, E>(): ValueRecombiner<
  ValidatedValue<T[], E>,
  ValidatedArrayMap<T, E>
> {
...
function extractArrayChildValidity<T, E>(
...
function updateArrayValidity<E>(
